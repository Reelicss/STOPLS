...
addEmote("Needy Balance", 117286638697108, 0, "Oct 14, 2025")  -- Needy Balance :contentReference[oaicite:2]{index=2}  
addEmote("[BEST] Soda Pop", 87905326034362, 0, "Aug 9, 2025") 
addEmote("Jigsaw Emote", 101358566209195, 0, "Oct 10, 2025")
addEmote("Electro Shuffle", 105735403290637, 0, "Oct 10, 2025")
addEmote("Windy Balance", 125555848685752, 0, "Oct 10, 2025")
...
addEmote("Whip and Nae Nae", 127101562757517, 0, "Oct 4, 2025")
addEmote("watch it move! [BEST]", 138446443552792, 0, "Oct 4, 2025")
...
addEmote("WOOF BARK WOOF", 88859617281337, 39, "Sep 09, 2025")
addEmote("catwalk walk", 87739743400914, 39, "Sep 09, 2025")
addEmote("sharp's hips sway", 80963950541052, 39, "Sep 09, 2025")
addEmote("slap", 119507472429934, 39, "Sep 09, 2025")
